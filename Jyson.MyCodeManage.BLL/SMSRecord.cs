...
namespace Jyson.MyCodeManage.BLL
{
	...
	{
		private readonly DAL.SMSRecord dal=new DAL.SMSRecord();
		public SMSRecord()
		{}
		#region  BasicMethod
		...
		{
			return dal.Exists(Phone,CreateDate,Id);
		}
		...
		public bool Delete(long Phone,DateTime CreateDate,int Id)
		{
			...
			return dal.Delete(Phone,CreateDate,Id);
		}
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.SMSRecord> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.SMSRecord> DataTableToList(DataTable dt)
		{
			List<Model.SMSRecord> modelList = new List<Model.SMSRecord>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.SMSRecord model;
